            ...
            <div className="container flex items-center justify-between">
                <a className="text-xl font-bold text-primary flex text-center" href="#hero">
                    <span className="relative z-10">
                        <span className="text-glow text-foreground">Gumball</span> Portfolio
                    </span>
                </a>
                ...
                <div className={`fixed inset-0 bg-background/95 backdrop-blue-md z-40 flex flex-col items-center justify-center transition-all duration-300 md:hidden
