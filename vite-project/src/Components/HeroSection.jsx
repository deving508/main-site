...
export const HeroSection = () => {
    return(
        ...
        <h1 className="text-[1.8rem] md:text-5xl font-bold tracking-tight">
            <span className="opacity-0 animate-fade-in"> Hi, I'm</span>
            <span className="text-primary opacity-0 animate-fade-in-delay-1"> Gumball</span>
            <span className="ml-2 opacity-0 animate-fade-in-delay-2"> Water</span>
        </h1>
